...
| 协议类型 | 端口 | 用途 | 数据格式 |
|----------|------|------|----------|
| UDP | 1900 | 网关自动发现 | JSON |
| TCP | 8080 | 初始连接与认证 | JSON |
| WebSocket | 8081 | 实时通信与状态同步 | JSON |
...
```json
{
  "msgId": "response_123456",
  "timestamp": "2023-01-01T12:00:00Z",
  "type": "GATEWAY_DISCOVER_RESPONSE",
  "data": {
    "gatewayId": "GW123456",
    "name": "澜鳐网关",
    "ip": "192.168.10.1",
...
```json
{
  "msgId": "auth_resp_123456",
  "timestamp": "2023-01-01T12:00:00Z",
  "type": "GATEWAY_AUTH_RESPONSE",
  "data": {
    "success": true,
    "token": "认证令牌",
    "websocketUrl": "ws://192.168.10.1:8081",
    "assignedIp": "192.168.10.100"
  }
}
```
...
```json
{
  "msgId": "get_gateway_logs_123456",
  "timestamp": "2023-01-01T12:00:00Z",
  "type": "GATEWAY_LOGS_REQUEST",
  "data": {
    "level": "info",
...
```json
{
  "msgId": "get_gateway_logs_resp_123456",
  "timestamp": "2023-01-01T12:00:00Z",
  "type": "GATEWAY_LOGS_RESPONSE",
  "data": {
    "logs": [
      {
        "id": "LOG123456",
